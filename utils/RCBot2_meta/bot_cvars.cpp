...
ConVar bot_general_difficulty("rcbot_skill","1.0",0,"General difficulty of the bots. 1.0 = stock, < 1.0 easier, > 1.0 = harder");
...
// CBASEENTITY OFFSETS
//ConVar rcbot_acceptinput_offset("rcbot_acceptinput_offset",			"36",  0, "offset for accept input function");
