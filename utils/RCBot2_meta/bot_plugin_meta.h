...
public: //hooks
	...
	inline static CBaseEntity *TF2_getPlayerWeaponSlot(edict_t *pPlayer, int iSlot);
	inline static void TF2_removeWearable(edict_t *pPlayer, CBaseEntity *pWearable);
	inline static void TF2_removePlayerItem(edict_t *pPlayer, CBaseEntity *pItem);
	static void TF2_RemoveWeaponSlot(edict_t *pPlayer, int iSlot);
	inline static void TF2_equipWeapon(edict_t *pPlayer, CBaseEntity *pWeapon);
	...
	inline static void TF2_equipWearable(edict_t *pPlayer, CBaseEntity *pWearable);
